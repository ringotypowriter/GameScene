...
public class FunctionResetScheduler implements IFunction {
    /**
     * resetScheduler(scheduler:$scheduler$ (, gameScene: $gameScene$))
     * @param argument
     * @param whereInvoke
     * @param isAsync
     * @return
    ...
    public boolean execute(Map<String, String> argument, GameScene whereInvoke, boolean isAsync) {
        ...
        scene.getSchedulers().resetIfExist(argument.get("scheduler"));
        return true;
    }

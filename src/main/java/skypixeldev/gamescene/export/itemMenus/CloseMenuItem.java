...
/**
 * A {@link cn.bitpixel.general.itemMenus.StaticMenuItem} that closes the
 * {@link cn.bitpixel.general.itemMenus.ItemMenu}.
 */
public class CloseMenuItem extends StaticMenuItem {

    public CloseMenuItem() {
        super(ChatColor.RED + "�ر�", new ItemStack(Material.RECORD_4));
    }
